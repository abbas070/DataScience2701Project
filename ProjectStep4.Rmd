...
countApp <- read.csv("AppCount.csv", header = T)
...
averageApp <- read.csv("AvgWage.csv", header = T)

states1 = geojsonio::geojson_read("gz_2010_us_040_00_20m.json",what="sp")
